...
class VggsoundCurationDataset(Dataset):
    def __init__(self):
        self.audio_lists = glob("./landscape_curation/*.npy")  # Put postprocessed audio files here
...
class VggsoundCurationTestDataset(Dataset):
    def __init__(self):
        self.audio_lists = glob("/vggsound_test_curation/*.npy") # Put postprocessed audio test files here, 여기에 UnAV dataset의 audio feature(.npy) 넣어보기
        self.time_length = 864
        self.n_mels = 128
        self.num_frames = 5
        #self.text_aug = EDA()
